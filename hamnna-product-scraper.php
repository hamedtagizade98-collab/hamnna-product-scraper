 ...
 * Description: Imports available products from hamnna.ir, skips existing products, checks every 10 minutes, and provides exact manual price synchronization.
 * Version: 1.2.0
 * Author: Hamnna
...
define('HAMNNA_SCRAPER_VERSION','1.2.0');
...
add_action('admin_post_hamnna_scraper_run',['Hamnna_Scraper','manual_run']);
add_action('admin_post_hamnna_scraper_clear_logs',['Hamnna_Scraper','clear_logs']);
add_action('admin_post_hamnna_scraper_reset_queue',['Hamnna_Scraper','reset_queue']);
add_action('admin_post_hamnna_price_sync',['Hamnna_Scraper','price_sync_action']);
