...
define('HAMNNA_SCRAPER_VERSION','1.5.0');
...
add_action('plugins_loaded', function(){
    if (did_action('elementor/loaded') && class_exists('Elementor\\Plugin')) {
        require_once HAMNNA_SCRAPER_DIR.'includes/class-hamnna-elementor-product-slider.php';
        Hamnna_Elementor_Product_Slider::init();
    }
});
