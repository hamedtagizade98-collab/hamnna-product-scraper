 ...
 * Description: Imports available products from hamnna.ir into WooCommerce every 3 hours, skipping existing products and unavailable products.
 * Version: 0.1.0
 * Author: Hamnna
...
define('HAMNNA_SCRAPER_VERSION', '0.1.0');
